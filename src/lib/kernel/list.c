...
/*
  Finds and returns the first element in the given list that 
  satisfies the given condition.
  Can either use an ELEM to compare or other parameters with AUX.
 */
struct list_elem *
list_find (struct list *list, struct list_elem *elem, list_less_func *check, void *aux) {
  struct list_elem *e;
